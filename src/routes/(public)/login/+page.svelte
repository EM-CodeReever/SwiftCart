    ...
    <form class="mx-auto flex w-full max-w-lg flex-col rounded-xl sm:border sm:border-border sm:bg-backgroundSecondary mt-6 p-4 sm:p-20">
        <div class="flex w-full flex-col gap-2">
            <div class="flex flex-col items-center space-y-3">
                ...
                <p class="text-sm">Sign in to access your <span class="text-error">SwiftCart</span> account</p>
            </div>
            <!-- <div class="flex w-full flex-col gap-2">
        ...
        <div class="form-group">
            ...
            <div class="form-field">
                <div class="form-control">
                    <a href="/register" class="link link-underline-hover link-primary text-sm">Don't have an account? Sign Up</a>
                </div>
            </div>
        </div>
    </form>
