...
<div class="max-w-3xl flex items-center space-x-5 mt-3">
    <span class="flex flex-col space-y-3  w-fit h-fit">
        <p class="text-lg sm:text-2xl font-bold text-left">{name}</p>
